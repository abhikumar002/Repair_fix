...
const steps = [
  {
    ...
    description:
      "Choose a time that works for you. Instant confirmation, live tracking, and zero rescheduling fees.",
    icon: Home,
  },
  {
    title: "Technician dispatch",
    description:
      "Certified SwiftFix experts travel in fully equipped mobile labs with sanitized workstations and OEM-grade parts.",
    icon: Truck,
  },
  {
    title: "Precision repair & QA",
    description:
      "On-site repairs finished in under 30 minutes, followed by diagnostics, calibration, and protective add-ons.",
    icon: Wrench,
  },
  {
    title: "Lifetime protected",
    description:
      "Repairs are secured with our lifetime craftsmanship guarantee and ongoing health monitoring from the SwiftFix app.",
    icon: ShieldCheck,
  },
];
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-3">
          ...
          <p className="max-w-3xl text-base leading-relaxed text-muted-foreground">
            Our on-demand repair platform blends best-in-class technicians,
            rigorous quality checks, and proactive care so you never miss a
            beat.
          </p>
        </div>
      </div>
