...
const appointmentSteps = [
  {
    title: "Choose device",
    description:
      "Select the phone, tablet, laptop, or wearable that needs service.",
    icon: Smartphone,
  },
  {
    title: "Pick a timeslot",
    description:
      "We offer 2-hour arrival windows from 8:00 AM – 9:00 PM every day.",
    icon: Clock,
  },
  {
    title: "Confirm location",
    description:
      "Our technicians come to your home, office, or a nearby café—wherever works best.",
    icon: Home,
  },
  {
    title: "Track technician",
    description:
      "Get live ETA updates, technician profiles, and chat support in the SwiftFix app.",
    icon: Calendar,
  },
];
    ...
    <div className="space-y-12">
      <header className="space-y-4">
        ...
        <h1 className="font-heading text-4xl font-bold text-foreground">
          Schedule your SwiftFix appointment
        </h1>
        <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
          Complete the steps below and a concierge specialist will reach out
          within minutes to finalize your booking. Prefer a call? Speak to a
          real person at{" "}
          <a
      ...
      <div className="grid gap-6 rounded-[2.5rem] border border-border/70 bg-white/90 p-8 shadow-[0_32px_80px_-45px_rgba(14,165,233,0.35)] lg:grid-cols-[1.1fr_minmax(0,0.9fr)]">
        <div className="space-y-6">
          <div className="rounded-3xl border border-primary/20 bg-primary/5 p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Tell us what broke and where to meet you. A SwiftFix coordinator
              will text back in under five minutes to confirm details, share
              pricing, and dispatch a technician.
            </p>
            <Link
              to="/"
        ...
        <aside className="flex flex-col gap-6 rounded-3xl border border-dashed border-primary/30 bg-primary/5 p-6">
          <div>
            ...
            <a
              href="tel:+18005551234"
              className="mt-3 block text-3xl font-bold text-foreground"
            >
              Call +1 (800) 555-1234
            </a>
